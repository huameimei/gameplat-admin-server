...
public class ActivityInfoController {
  ...
  public void add(
    ...
    if (StringUtils.isNotNull(activityInfoAddDTO.getActivityLobbyId())) {
      activityInfoService.checkActivityLobbyId(
          activityInfoAddDTO.getActivityLobbyId(), activityInfoAddDTO.getId());
    }
  ...
  public void update(
    ...
    if (StringUtils.isNotNull(activityInfoUpdateDTO.getActivityLobbyId())) {
      activityInfoService.checkActivityLobbyId(
          activityInfoUpdateDTO.getActivityLobbyId(), activityInfoUpdateDTO.getId());
    }
