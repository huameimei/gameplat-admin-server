...
public class ChatRedEnvelopeController {
    ...
    @Autowired
    private ChatRedEnvelopeService redEnvelopeService;

    @Autowired
    private ChatRedEnvelopeDrawService chatRedEnvelopeDrawService;

    @Autowired
    private ChatRedEnvelopeRecordService chatRedEnvelopeRecordService;
    ...
    public IPage<ChatRedEnvelopeRecord> page(PageDTO<ChatRedEnvelopeRecord> page, @Validated ChatRedEnvelopeRecordQueryDTO dto){
