...
public class ActivityInfoEnum {
  ...
  public enum QualificationStatus {
    ...
    QualificationStatus(int value, String desc) {
      this.value = value;
      this.desc = desc;
    }
  ...
  public enum BlackList {
    ...
    BlackList(int value, String desc) {
      this.value = value;
      this.desc = desc;
    }
  ...
  public enum ApplyWay {
    ...
    ApplyWay(int value, String desc) {
      this.value = value;
      this.desc = desc;
    }
  ...
  public enum AuditWay {
    ...
    AuditWay(int value, String desc) {
      this.value = value;
      this.desc = desc;
    }
