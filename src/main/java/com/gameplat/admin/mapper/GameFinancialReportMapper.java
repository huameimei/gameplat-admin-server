...
public interface GameFinancialReportMapper extends BaseMapper<GameFinancialReport> {
    ...
    Page<GameFinancialReportVO> findGameFinancialReportPage(Page<GameFinancialReport> page, @Param("dto")GameFinancialReportQueryDTO dto);

    List<GameFinancialReport> initGameFinancialReport(@Param("statisticsTime") String statisticsTime,
