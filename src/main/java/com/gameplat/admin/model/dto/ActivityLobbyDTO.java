...
/** 活动大厅DTO @Author: lyq @Date: 2020/8/14 15:15 @Description: */
@Data
...
public class ActivityLobbyDTO implements Serializable {
  ...
  @Schema(
      description =
          "活动类型（1 充值活动(统计项目(statisItem)选项中的1,2,3,4,5项可选)；2 游戏活动(统计项目(statisItem)选项中的6,7,8,9,10,11,12项可选)")
