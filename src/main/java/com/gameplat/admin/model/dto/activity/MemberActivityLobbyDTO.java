...
public class MemberActivityLobbyDTO implements Serializable {
    ...
    private List<MemberLobbyDiscountDTO> lobbyDiscount;
    ...
    public void setStartTime(String startTime) {
        this.startTime = DateUtil.StringToDate(startTime, DateUtil.SIMPLE);
    }
