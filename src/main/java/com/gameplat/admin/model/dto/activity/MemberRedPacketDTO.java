...
public class MemberRedPacketDTO implements Serializable {
    ...
    private List<com.live.cloud.backend.model.activity.dto.MemberRedPacketConditionDTO> redPacketCondition;

    @ApiModelProperty(value = "奖品列表")
    private List<com.live.cloud.backend.model.activity.dto.MemberActivityPrizeDTO> activityPrize;
