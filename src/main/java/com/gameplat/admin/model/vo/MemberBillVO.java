...
public class MemberBillVO implements Serializable {
    ...
    @Excel(
            name = "账变类型",
            width = 16,
            replace = {"转账充值_1", "线上支付_2", "彩票下注_3", "彩票派彩_4", "用户提款_6", "撤单返款_7", "提款失败_8", "退佣(分红)_10", "后台转入_11", "后台转出_12",
                    "注册送彩金_16", "代理返点_17", "人工存入_18", "给予返水_19", "活动优惠_20", "追号返款_21", "系统奖励_22", "代理日工资_23", "其他充值_25", "打和返款_26",
                    "冲销返水_27", "人工提出_28", "追号扣款_29", "优惠扣除_30", "其他扣除_31", "冲销派奖_32", "额度转入_33", "额度转出_34", "体育下注_35", "体育结算_36",
                    "违规退还本金_37", "重新结算_38", "取消订单_39", "真人返点_40", "真人返点回收_41", "电竞王者荣耀结算_43", "电竞王者荣耀取消订单_44", "棋牌支出_50", "棋牌收入_51", "转出余额宝_52",
                    "转入余额宝_53", "升级奖励_54", "俸禄发放_55", "俸禄回收_56", "借呗放款_57", "借呗还款_58", "活动彩金_59", "绑定手机送彩_60","充值卡充值_63"
                    },
