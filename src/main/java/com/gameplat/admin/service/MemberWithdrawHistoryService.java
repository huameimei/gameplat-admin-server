...
public interface MemberWithdrawHistoryService extends IService<MemberWithdrawHistory> {
  ...
  IPage<MemberWithdrawHistoryVO> findPage(Page<MemberWithdrawHistory> page,
      UserWithdrawHistoryQueryDTO dto);

  MemberWithdrawHistorySummaryVO findSumMemberWithdrawHistory(UserWithdrawHistoryQueryDTO dto);
