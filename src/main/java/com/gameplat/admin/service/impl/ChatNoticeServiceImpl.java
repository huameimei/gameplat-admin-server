...
public class ChatNoticeServiceImpl  extends ServiceImpl<ChatNoticeMapper, ChatNotice> implements ChatNoticeService {

    @Autowired
    private ChatNoticeConvert chatNoticeConvert;
    ...
    public IPage<ChatNoticeVO> page(PageDTO<ChatNotice> page, ChatNoticeQueryDTO dto) {
        return this.lambdaQuery()
                ...
                .like(ObjectUtil.isNotEmpty(dto.getNoticeTitle()), ChatNotice::getNoticeTitle, dto.getNoticeTitle())
