...
public class DivideFissionConfigServiceImpl extends ServiceImpl<DivideFissionConfigMapper, DivideFissionConfig> implements DivideFissionConfigService {
    @Autowired
    private DivideFissionConfigMapper fissionConfigMapper;
    @Autowired
    ...
    public Map<String, Object> getFissionConfigForEdit(String userName, String lang) {
        ...
        Map<String, JSONObject> ownerFissionConfigMap = JSONUtil.toBean(ownerFissionConfig.getDivideConfig(), Map.class);
        ...
        if (StrUtil.isNotBlank(fissionRecycleConfig)) {
            fissionConfigLevelVos = JSONUtil.toList(JSONUtil.parseArray(fissionRecycleConfig), FissionConfigLevelVo.class);
        }

        Map<String, Object> returnMap = new HashMap<>();
        returnMap.put("divideConfigMap", tmpMap);
        returnMap.put("recycleConfig", fissionConfigLevelVos);
        returnMap.put("outDivideRatio", ownerFissionConfig.getRecycleOutConfig() == null ? 0 : ownerFissionConfig.getRecycleOutConfig());
        return returnMap;
    }
    ...
    public void edit(DivideConfigDTO divideConfigDTO, String lang) {
        ...
        Map<String, List<FissionDivideConfigVo>> ownerFissionConfigMap = divideConfigDTO.getOwnerFissionConfigMap();
        ...
        editObj.setRecycleOutConfig(divideConfigDTO.getOutRecycleConfig() == null ?
                BigDecimal.ZERO:divideConfigDTO.getOutRecycleConfig());
