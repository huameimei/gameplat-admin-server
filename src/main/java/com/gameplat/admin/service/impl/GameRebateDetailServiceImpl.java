...
public class GameRebateDetailServiceImpl extends
    ServiceImpl<GameRebateDetailMapper, GameRebateDetail> implements GameRebateDetailService {
  ...
  public void createGameRebateDetail(GameRebatePeriod gameRebatePeriod) {
    List<GameRebateReport> gameRebateReportList = gameRebateReportMapper
        .queryGameRebateReportByStatus(gameRebatePeriod.getId(), GameRebateReportStatus.UNACCEPTED.getValue());
