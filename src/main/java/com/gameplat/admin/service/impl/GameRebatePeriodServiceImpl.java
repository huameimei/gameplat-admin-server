...
public class GameRebatePeriodServiceImpl extends
    ServiceImpl<GameRebatePeriodMapper, GameRebatePeriod> implements GameRebatePeriodService {

  @Autowired
  private GameRebatePeriodMapper gameRebatePeriodMapper;

  @Autowired
  private GameRebatePeriodConvert gameRebatePeriodConvert;
  ...
  @Override
  public IPage<GameRebatePeriodVO> queryGameRebatePeriod(Page<GameRebatePeriod> page,
      GameRebatePeriodQueryDTO dto) {
    ...
    IPage<GameRebatePeriodVO> gameRebatePeriodVoPage = gameRebatePeriodMapper.selectPage(page, queryWrapper)
  ...
  private void prePersist(GameRebatePeriod gameRebatePeriod){
    ...
    gameRebatePeriod.setName(beginDate.getTime() == endDate.getTime() ? DateUtils.format(beginDate)
  ...
  public int countByDateRange(Long id, Date beginDate, Date endDate) {
    return this.lambdaQuery()
        ...
        .and(wrapper -> wrapper.and(i ->
            i.le(ObjectUtils.isNotEmpty(beginDate), GameRebatePeriod::getBeginDate, beginDate)
                .ge(ObjectUtils.isNotEmpty(beginDate), GameRebatePeriod::getEndDate, beginDate)))
        .or()
        .and(i -> i.le(ObjectUtils.isNotEmpty(endDate), GameRebatePeriod::getBeginDate, endDate)
