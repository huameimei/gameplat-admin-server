...
@Service
public class GameTransferInfoServiceImpl extends
    ServiceImpl<GameTransferInfoMapper, GameTransferInfo> implements GameTransferInfoService {

  @Override
  public GameTransferInfo getInfoByMemberId(Long memberId) {
    return this.lambdaQuery()
        .eq(ObjectUtils.isNotNull(memberId), GameTransferInfo::getMemberId,memberId).one();
  }
  ...
  public void update(Long memberId, String code, String orderNo) {
    ...
    lambdaUpdateWrapper.eq(GameTransferInfo::getMemberId,memberId)
