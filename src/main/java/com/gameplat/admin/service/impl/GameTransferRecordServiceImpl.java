...
import com.gameplat.admin.convert.GameTransferRecordConvert;
...
public class GameTransferRecordServiceImpl extends
    ServiceImpl<GameTransferRecordMapper, GameTransferRecord> implements GameTransferRecordService {

  @Autowired
  private GameTransferRecordMapper gameTransferRecordMapper;

  @Autowired
  private MemberService memberService;

  @Autowired
  private GameTransferRecordConvert gameTransferRecordConvert;
  ...
  public PageDtoVO<GameTransferRecord> queryGameTransferRecord(Page<GameTransferRecord> page,
    ...
    queryWrapper.eq(StringUtils.isNotBlank(dto.getPlatformCode()),"platform_code", dto.getPlatformCode());
    ...
    Page<GameTransferRecord> liveRebatePeriodVoPage = gameTransferRecordMapper.selectPage(page, queryWrapper);
    ...
    GameTransferRecord total = Optional.ofNullable(gameTransferRecordMapper.selectOne(queryWrapper)).orElse(new GameTransferRecord());
