...
public class MemberGrowthBannerServiceImpl
    extends ServiceImpl<MemberGrowthBannerMapper, MemberGrowthBanner>
    implements MemberGrowthBannerService {

  @Autowired private MemberGrowthBannerConvert memberGrowthBannerConvert;
  ...
  /** 查 */
  @Override
  public IPage<MemberGrowthBannerVO> getList(
      PageDTO<MemberGrowthBanner> page, MemberGrowthBannerQueryDTO dto) {
    return this.lambdaQuery()
        .eq(
            ObjectUtil.isNotEmpty(dto.getCilentType()),
            MemberGrowthBanner::getCilentType,
            dto.getCilentType())
        .eq(
            ObjectUtil.isNotEmpty(dto.getAreaType()),
            MemberGrowthBanner::getAreaType,
            dto.getAreaType())
        .page(page)
