...
public class RechargeOrderServiceImpl extends ServiceImpl<RechargeOrderMapper, RechargeOrder>
  ...
  @Override
  public PageExt<RechargeOrderVO, SummaryVO> findPage(Page<RechargeOrder> page,
  ...
  public void accept(Long id, UserCredential userCredential) throws Exception {
    ...
    if (TrueFalse.TRUE.getValue() != rechargeOrder.getPointFlag()) {
      log.info("充值不增加成长值 account={}，orderNo={},pointFlag={}", rechargeOrder.getAccount(),
  ...
  public void add(Member member, BigDecimal balance, RechargeOrder rechargeOrder, String content,
