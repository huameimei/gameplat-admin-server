...
public class RoutingDelegate {
    ...
    public ResponseEntity<String> redirect(HttpServletRequest request, Map<String, String> addHeaders, String routeUrl, String prefix) {
        try {
            String redirectUrl = createRedirectUrl(request, routeUrl, prefix);
    ...
    private RequestEntity createRequestEntity(HttpServletRequest request, Map<String, String> addHeaders, String url) throws URISyntaxException, IOException {
        String method = request.getMethod();
        HttpMethod httpMethod = HttpMethod.resolve(method);
    ...
    private MultiValueMap<String, String> parseRequestHeader(HttpServletRequest request, Map<String, String> addHeaders) {
