...
public class SalaryConfigServiceImpl
        extends ServiceImpl<SalaryConfigMapper, SalaryConfig>
    ...
    public IPage<SalaryConfigVO> queryPage(PageDTO<SalaryConfig> page, SalaryConfigDTO dto) {
        ...
        IPage<SalaryConfigVO> pageResult = salaryConfigMapper.selectPage(page, queryWrapper)
                .convert(salaryConfigConvert::toVo);
        ...
        for (SalaryConfigVO vo : pageResult.getRecords()) {
            ...
            vo.setIsDirectBol(vo.getIsDirect() == TrueFalse.TRUE.getValue() ? true:false);
        }
        return pageResult;
    }
    ...
    public void add(SalaryConfigDTO dto) {
        ...
        saveObj.setIsDirect(dto.getIsDirectBol()? TrueFalse.TRUE.getValue():TrueFalse.FALSE.getValue());
    ...
    public void edit(SalaryConfigDTO dto) {
        ...
        editObj.setIsDirect(dto.getIsDirectBol()? TrueFalse.TRUE.getValue():TrueFalse.FALSE.getValue());
