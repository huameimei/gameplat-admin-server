...
public class SalaryGrantServiceImpl
    ...
    @Autowired
    private SalaryGrantConvert salaryGrantConvert;
    ...
    public IPage<SalaryGrantVO> queryPage(PageDTO<SalaryGrant> page, SalaryGrantDTO dto) {
        ...
        queryWrapper
                .eq(ObjectUtils.isNotNull(dto.getPeriodsId()),SalaryGrant::getPeriodsId, dto.getPeriodsId())
                ...
                .eq(ObjectUtils.isNotNull(dto.getAgentLevel()),SalaryGrant::getAgentLevel, dto.getAgentLevel())
                .eq(ObjectUtils.isNotNull(dto.getReachStatus()),SalaryGrant::getReachStatus, dto.getReachStatus())
                .eq(ObjectUtils.isNotNull(dto.getGrantStatus()),SalaryGrant::getGrantStatus, dto.getGrantStatus());
        queryWrapper.orderByDesc(SalaryGrant::getCreateTime);
        IPage<SalaryGrantVO> pageResult = salaryGrantMapper.selectPage(page, queryWrapper)
                .convert(salaryGrantConvert::toVo);
        return pageResult;
    }
    ...
    public void change(Long id, BigDecimal salaryAmount) {
        ...
        SalaryGrant salaryGrant = SalaryGrant.builder()
                .id(id)
